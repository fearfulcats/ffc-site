...
const DialogOverlay = <T extends ValidComponent = "div">(
  ...
  return (
    <DialogPrimitive.Overlay
      class={cn(
        "fixed inset-0 z-50   data-[closed]:fade-out-0 data-[expanded]:fade-in-0",
        props.class
      )}
      {...rest}
    />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        class={cn(
          "fixed  z-50 grid max-h-screen w-full gap-4 overflow-y-auto border bg-background p-6 shadow-lg duration-200  data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95 data-[closed]:slide-out-to-left-1/2 data-[closed]:slide-out-to-top-[48%] data-[expanded]:slide-in-from-left-1/2 data-[expanded]:slide-in-from-top-[48%] sm:rounded-lg",
          props.class
        )}
        {...rest}
      >
